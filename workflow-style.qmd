...
Un bon style de code c'est comme une ponctuation correcte : vous pouvez vous en passer, mais cela rend les choses beaucoup plus faciles à lire.
...
En règle générale, il est préférable de préférer les noms longs et descriptifs qui sont faciles à comprendre plutôt que les noms concis qui sont rapides à taper.
...
Mettez toujours un espace après une virgule, comme en anglais standard.
...
C'est acceptable d'ajouter des espaces supplémentaires si cela améliore l'alignement.
...
Nous souhaitons que cette transition ne soit pas nécessaire, mais malheureusement, ggplot2 a été écrit avant la découverte du pipe.
...
1.  Reformatez les pipelines suivants en suivant les directives ci-dessus.
