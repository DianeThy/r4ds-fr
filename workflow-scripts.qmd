...
En travaillant les chapitres futurs, nous vous recommandons vivement de commencer dans l'éditeur de scripts et de pratiquer vos raccourcis clavier.
...
Trois principes importants pour le nommage des fichiers sont les suivants :
...
[^workflow-scripts-1]: Sans parler du fait que vous tentez le sort en utilisant « final » dans le nom 😆 La bande dessinée Piled Higher and Deeper a une [vignette amusante à ce sujet](https://phdcomics.com/comics/archive.php?comicid=1531).
...
Un jour, vous devrez apporter des données du monde extérieur dans R et envoyer des résultats numériques et des figures de R vers le monde extérieur.
...
#|   sous-répertoire pour son emplacement et cliquez sur  
#|   Create Project.
#| fig-alt: |
...
Si vous ne le stockez pas quelque part de sensé, il sera difficile de le trouver à l'avenir !
...
Un chemin relatif est relatif au répertoire de travail, c'est-à-dire la maison du projet.
...
Il y a une autre différence importante entre systèmes d'exploitation : la façon dont vous séparez les composants du chemin.
